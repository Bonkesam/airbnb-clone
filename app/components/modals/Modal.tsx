...
const Modal: React.FC<ModalProps> = ({
    isOpen,onClose, onSubmit, title, body, footer, disabled, actionlabel, secondaryAction, secondaryActionLabel
}) => {
  ...
  return (
    <>
        <div className="justify-center item-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-100/70">
